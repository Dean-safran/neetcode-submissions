...
class Solution:
    ...
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        def helper(preorder, inorder, l, r) :
            ...
            root.left = helper(preorder, inorder, l, rootIndexInorder - 1 )   #left side if it exists
            root.right = helper(preorder, inorder, rootIndexInorder + 1, r)  #right side if it exists
            return root  
