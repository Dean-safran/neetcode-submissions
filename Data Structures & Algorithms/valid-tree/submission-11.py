"""
time : o(v + 2v*inverse_ackermann function)
We only check and union at most n-1 pairs of nodes since we only 
run our algorithm if there are exactly n-1 edges
space : o(v)
we store two arrays of size n that support 
the union find class + operations
"""
