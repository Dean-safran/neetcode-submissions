...
# anywhere where I mentioned could be alpha(n) where alpha is 
# the inverse ackerman function, which is nearly constant, hence 
...
# by 1)
# since we use path compression, 
# the while loop finds a parent in 2 loops max since we connect
# new blocks directly to the component root when called on
